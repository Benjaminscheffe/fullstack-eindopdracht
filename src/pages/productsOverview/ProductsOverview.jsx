                ...
                <div className="container extra-small-container">
                    ...
                    <div className="beats-container">
                        { beats.length > 0 ? beats.map((beat) =>
                            <BeatBlock title={beat.title} artist={beat.userId} bpm={beat.bpm} price={beat.price} image={`http://localhost:8080/beats/${beat.id}/image`} error={error}>
                                <ButtonComponent classNames="btn-small btn-border btn-inverted btnReset" buttonText="Go to the beat" noteIcon={true} buttonFunction={() => location.href=`/beats/${beat.id}`}  />
                            </BeatBlock>
